...
create index ix_note_table_col_width_table_id
...
create unique index uq_note_checklist_category_name_alive
    on note.checklist_category (checklist_id, name)
    where is_deleted = false;

create index ix_note_checklist_category_checklist_id
...
create index ix_note_checklist_item_checklist_id
    on note.checklist_item (checklist_id);

create index ix_note_checklist_item_category_id
